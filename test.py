...
#         tk.Label(title_frame, text="Algorithm Visualizer",
#                 font=('Helvetica', 24, 'bold'),
#                 fg='white', bg='#2c3e50').pack(pady=20)

#         # Algorithm selection frame
#         selection_frame = tk.Frame(self.main_frame, bg='#ecf0f1')
#         selection_frame.pack(pady=20, padx=50, fill=tk.BOTH, expand=True)

#         # Algorithm buttons
#         self.create_algo_button(selection_frame, 
#                               "Integer Multiplication",
#                               "Karatsuba Algorithm for large numbers",
#                               lambda: self.start_algorithm("multiplication"))
        
#         self.create_algo_button(selection_frame,
#                               "Closest Pair of Points",
#                               "Find the closest pair of points in 2D space",
#                               lambda: self.start_algorithm("closest_pair"))

#     def create_algo_button(self, parent, title, description, command):
...
#         self.main_frame.pack_forget()
#         if algo_type == "multiplication":
#             IntegerMultiplicationPage(self.root, self.show_main_page)
#         else:
#             ClosestPairVisualizer(self.root, self.show_main_page)
...
#         tk.Label(input_frame, text="Number 1:").grid(row=0, column=0, padx=5)
#         self.num1_entry = tk.Entry(input_frame, width=40)
#         self.num1_entry.grid(row=0, column=1, padx=5)

#         tk.Label(input_frame, text="Number 2:").grid(row=1, column=0, padx=5)
#         self.num2_entry = tk.Entry(input_frame, width=40)
#         self.num2_entry.grid(row=1, column=1, padx=5)
